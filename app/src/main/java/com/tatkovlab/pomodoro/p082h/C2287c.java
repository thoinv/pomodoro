...
public class C2287c implements OnClickListener {
    public void onClick(View view) {
        new MaterialDialog(view.getContext()).mo5477a((int) R.string.add_task_dialog_header).mo5507k(16384).mo5506j(R.color.dark_brown).mo5496c((int) R.color.dark_brown).mo5503g(R.color.dark_brown).mo5487a(C1194i.LIGHT).mo5502f(R.string.save).mo5478a(1, 50).mo5480a((int) R.string.add_task_dialog_hint, 0, (C1177d) new C1177d() {
            /* renamed from: a */
